...
namespace Order.Domain.Interfaces.Services
{
    public interface IUserService
    {
        ...
        Task<Response<UserModel>> GetByLoginAsync(string Email);
        Task<Response<List<UserModel>>> ListByFilterAsync(string userId = null, string email = null);
        Task<Response> CodeVerification(string email, string codeVerification);
    }
}
