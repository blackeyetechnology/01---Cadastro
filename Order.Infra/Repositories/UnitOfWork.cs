...
namespace Order.Infra.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(IDbConnector dbConnector, IConfiguration configuration)
        {
        ...
        public IUserRepository UserRepository => _userRepository ?? (_userRepository = new UserRepository(dbConnector, configuration));
